...
sidebarOrder: 14
sourcePath: docs/guide/14-artifacts-reference.md
sourceCommit: 3c76878775915b6dc510fa7e1ef0991ba510cd53
sourceHash: a63eae09b7eb2e9e53cbdbbb8d2951c075565f7fe98a59aaf653fc5474822939
translationStatus: current
---

<a id="artifacts-reference"></a>
# 成果物リファレンス
...
| 2.2 プラクティス発見 | `team-practices.md`、`discovered-rules.md`、`evidence.md`、`practices-discovery-timestamp.md`（確認後にスペースメモリ層、すなわち `aidlc/spaces/<space>/memory/team.md` と `memory/project.md` へ昇格） | 条件付き |
...
| 3.5 コード生成 | `code-generation-plan.md`、`code-summary.md`（コードはワークスペースルートに出る） | 常に実行、作業ユニットごと |

...
sidebarOrder: 19
sourcePath: docs/guide/workshop-mode.md
sourceCommit: 3c76878775915b6dc510fa7e1ef0991ba510cd53
sourceHash: 28a8b98d6f0504edcd16f60a8c01ac4ceb326bb6fb094d1b099d038f89182bc6
translationStatus: current
---

<a id="workshop-mode"></a>
# ワークショップモード
...
プロジェクトごとの既定スコープは、`.claude/settings.json` に `AWS_AIDLC_DEFAULT_SCOPE=workshop` を設定しても構いません。設定しておけば、各参加者がクローン内で `/aidlc` を実行するだけでワークショップ向けの経路選択を自動的に得られ、フラグを覚える必要がなくなります。詳細は [カスタマイズ § プロジェクトごとの既定スコープ](13-customization.md#per-project-default-scope) を参照してください。
...
- [分岐戦略（ナレッジファイル）](../../core/knowledge/aidlc-pipeline-deploy-agent/branching-strategies.md) — aidlc-pipeline-deploy-agent のマージ委譲契約

...
sidebarOrder: 14
sourcePath: docs/reference/14-claude-features.md
sourceCommit: 3c76878775915b6dc510fa7e1ef0991ba510cd53
sourceHash: 4d92e6a1dabf14d7b0f74cc115d6fea4562926f9bf1a98c919d7d03838681b59
translationStatus: current
---

<a id="harness-primitives-mapping"></a>
# ハーネス・プリミティブの対応表
...
ハーネス追加時のソース契約は[新しいハーネスへの移植](../harness-engineering/09-porting-to-a-new-harness.md)を参照してください）。
...
ハーネス・エンジニア向けの作成方法は[ルールと学習ループ](../harness-engineering/05-rules-and-the-loop.md)にあります。
...
- [新しいハーネスへの移植](../harness-engineering/09-porting-to-a-new-harness.md) -- 上記の対応表へ列を追加する方法: マニフェスト、フック・アダプター、`emit.ts` 契約
- [他のハーネスで実行する](../guide/harnesses/README.md) -- ハーネス別の、Kiro と Codex におけるこれらのプリミティブの表現

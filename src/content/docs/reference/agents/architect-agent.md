...
sidebarOrder: 4
sourcePath: docs/reference/agents/architect-agent.md
sourceCommit: 3c76878775915b6dc510fa7e1ef0991ba510cd53
sourceHash: 2370379729e62b81ed2ddf285c17f6aee7616b5ca3a9f8981ccc623616d78844
translationStatus: current
---

<a id="aidlc-architect-agent----technical-reference"></a>
...
このエージェントは、他の 7 つの高判断エージェントと並んで `judgment` tier を担います。3 つの `templated` エージェント（デリバリー、パイプラインとデプロイ、オペレーションズ）は、
...
| units-generation | ユニット生成 | アプリケーション設計を、境界と依存 DAG を持つ実装可能な 作業ユニット に分解する。経済的な順序付け（何を最初に出荷するか、その理由）は delivery-planning ステージの判断である |
...
| 引き継ぎ先 | 成果物 |
|------------|--------|
| aidlc-developer-agent | 作業ユニット 仕様、API 契約、設計パターン |

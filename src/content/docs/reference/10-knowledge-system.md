...
sidebarOrder: 10
sourcePath: docs/reference/10-knowledge-system.md
sourceCommit: 3c76878775915b6dc510fa7e1ef0991ba510cd53
sourceHash: b50fe34308903109f71d377c86a8fed5dfd6b05e16fc99e696a517221d57cb76
...
`aidlc-state.md` ファイルは `.claude/knowledge/aidlc-shared/state-template.md` から作成されます。テンプレートでは、プロジェクト情報、スコープ設定、ワークスペースの状態、実行計画の概要、ランタイム状態、フェーズ進捗、ステージ進捗（チェックボックス）、現在の状態、セッション再開地点の各セクションを定義します。

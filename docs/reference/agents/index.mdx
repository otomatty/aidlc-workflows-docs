...
| 8 | [aidlc-developer-agent](/reference/agents/developer-agent) | コード生成、ワークスペース検出、リバースエンジニアリング |
| 9 | [aidlc-quality-agent](/reference/agents/quality-agent) | テスト戦略、テスト生成、性能検証 |
...
| [aidlc-developer-agent](/reference/agents/developer-agent) | reverse-engineering（コードスキャン）, code-generation | practices-discovery, functional-design, deployment-execution | judgment | Bash |
| [aidlc-quality-agent](/reference/agents/quality-agent) | build-and-test, performance-validation | practices-discovery, nfr-requirements | judgment | Bash |

...
- [エージェントガイド: aidlc-aws-platform-agent](/guide/agents/aws-platform-agent)
- [ステージドキュメント](https://github.com/awslabs/aidlc-workflows/blob/main/docs/reference/04-stages/)
- 出典: [`dist/claude/.claude/agents/aidlc-aws-platform-agent.md`](https://github.com/awslabs/aidlc-workflows/blob/main/dist/claude/.claude/agents/aidlc-aws-platform-agent.md)

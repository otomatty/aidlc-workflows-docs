...
- 出典: [`dist/claude/.claude/agents/aidlc-devsecops-agent.md`](https://github.com/awslabs/aidlc-workflows/blob/main/dist/claude/.claude/agents/aidlc-devsecops-agent.md)

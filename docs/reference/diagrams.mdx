...
>
> - 図 1 と 7: [アーキテクチャ](/reference/architecture)
> - 図 8: [オーケストレーター](/reference/orchestrator) -- セッション管理セクション
> - 図 9: [オーケストレーター](/reference/orchestrator) -- スコープルーティングセクション
> - 図 10: [ナレッジシステム](/reference/knowledge-system)
> - 図 11: [ステージプロトコル](/reference/stage-protocol) -- 承認ゲートセクション
> - 図 12: [オーケストレーター](/reference/orchestrator) -- 状態追跡セクション
...
> スコープルーティング表は、[オーケストレーターリファレンス -- スコープマッピング](/reference/orchestrator#scope-to-stage-mapping) を参照してください。
